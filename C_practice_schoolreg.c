...
int main()
{
    char name[50], bd[50], ad[50], em[50], citsh[50], fname[50], mname[50], prim[50], sec[50], ter[50], c1[50], c2[50], c3[50];
    int age;
    long int con;
